...
def run_gui(path=None, data=None):
    ...
    # Plotting windows
    p1 = pg.PlotWidget()    # raw movie window (top-mid), all contours are drawn here
    p2 = pg.PlotWidget()    # trace window (bottom-mid), calcium trace of the selected component
    p3 = pg.PlotWidget()    # denoised movie window (top-right), only selected contour is drawn here
